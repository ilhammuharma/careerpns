...
<body class="nav-on-header smart-nav">
    ...
    <form action="<?=$base_url?>resume-proses.php" enctype="multipart/form-data" method="post">
		<!-- Page header -->
		...
		?>
		<header class="page-header"  style="background-image: url(assets/img/h7.jpg);">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-4">
						<div class="form-group">
							...
							<input type="file" name="foto" class="dropify" src="image/<?=$data['foto'];?>" accept="image/*" class="img-rounded" width="250px" height="250px" data-default-file="image/<?=$data['foto'];?>" required>
							<!--<input type="file" name="foto" class="dropify" value="<?=$data['foto'];?>" data-default-file="assets/img/avatar.jpg" required>-->
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="tel" class="form-control" name="noPonsel" id="noPonsel" value="<?=$data['noPonsel'];?>" <?//=substr($data['noPonsel'], 3, 15);?> required>
							</div>
						</div>
						<!--<div class="form-group">
