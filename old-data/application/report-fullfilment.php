<?
	...
	else
	{
		...
		$list=mysql_query("select namaRecruitmentSuperintendent from fptk where namaRecruitmentSuperintendent like '%".$_POST['fullfilment']."%' $tanggal_sql group by namaRecruitmentSuperintendent");
		?>
			<style>
				.print tr td
				{
